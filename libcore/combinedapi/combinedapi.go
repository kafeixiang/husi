// Package combinedapi combined V2Ray API and Clash API,
// but not provide public gRPC or HTTP service.
package combinedapi
...
import (
	...
	_ "github.com/sagernet/sing-box/include" // Register after not include information to override it.
