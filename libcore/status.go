...
// EnableClashModeCallback set whether enable clash mode callback.
func (b *BoxInstance) EnableClashModeCallback(enable bool) {
	if !enable {
		b.api.SetModeUpdateCallback(nil)
		return
	}
	b.api.SetModeUpdateCallback(b.platformInterface.ClashModeCallback)
}
