...
class SagerNet : Application(),
    ...
    fun getStringCompat(@StringRes id: Int): String {
        return ContextCompat.getContextForLanguage(this).getString(id)
    }

    fun getStringCompat(@StringRes id: Int, vararg formatArgs: Any): String {
        return ContextCompat.getContextForLanguage(this).getString(id, *formatArgs)
    }

    fun getTextCompat(@StringRes id: Int): CharSequence {
        return ContextCompat.getContextForLanguage(this).getText(id)
    }
