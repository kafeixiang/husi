...
class ProxyGroupSettingsActivity :
    ...
    lateinit var interruptExistConnections: SwitchPreference
    ...
    override fun PreferenceFragmentCompat.createPreferences(
        ...
        interruptExistConnections = findPreference(Key.SERVER_INTERRUPT_EXIST_CONNECTIONS)!!
    ...
    fun updateManagement(management: Int = DataStore.serverManagement) {
        when (management) {
            GroupBean.MANAGEMENT_SELECTOR -> {
                interruptExistConnections.isVisible = true
            ...
            GroupBean.MANAGEMENT_BALANCER -> {
                interruptExistConnections.isVisible = false
                testURL.isVisible = false
                testInterval.isVisible = false
                idleTimeout.isVisible = false
                tolerance.isVisible = false
